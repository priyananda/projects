...
public class Attempts {
	public static List<AnswerAttempt> getAttempts(long teamId, String questionSet, long questionId) {
		...
		Query query = new Query(AnswerAttempt.ENTITY_NAME)
				.setFilter(
					CompositeFilterOperator.and(
						...
						new Query.FilterPredicate(AnswerAttempt.FIELD_SET, FilterOperator.EQUAL, questionSet),
	...
	public static JsonObject getAttemptsAsJson(long teamId, String questionSet, long questionId) {
		JsonArray array = new JsonArray();
		getAttempts(teamId, questionSet, questionId)
			.stream()
	...
	public static List<String> getLatestAnswers(long teamId){
		...
		Query query = new Query(AnswerAttempt.ENTITY_NAME)
			...
			.addSort(AnswerAttempt.FIELD_SET, SortDirection.ASCENDING)
