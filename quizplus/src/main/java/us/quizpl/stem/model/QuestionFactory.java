...
public class QuestionFactory {
	...
	private static ImmutableMap<String, Question> QUESTIONS = new ImmutableMap.Builder<String, Question>()
		...
		.put("3", new Question("satellite.*", 10))
		...
		.put("10", new Question("tesla", 20))
		.put("11", new Question("renewable", 20))
		.put("12", new Question(".*57.*", 20))
		.put("13", new Question("wrong", 25))
		.put("14", new Question("19254", 25))
		.put("15", new Question("1984", 25))
		.put("16", new Question("microscope", 25))
		.build();
